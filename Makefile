...
# Run
run_lsh:
	./$(TARGET) -d "../sift/sift_base.fvecs" -q "../sift/sift_query.fvecs" -k 10 -L 30 -w 1.5 -o output.dat -N 5 -R 200 -type sift -range true -lsh
...
run_ivfflat:
	./$(TARGET) -d "../sift/sift_base.fvecs" -q "../sift/sift_query.fvecs" -kclusters 256 -nprobe 20 -o output.dat -N 10 -R 30 -type sift -range false -ivfflat -seed 1
