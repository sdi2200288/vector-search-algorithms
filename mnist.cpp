...
// // ==========================================================
// // Helper: κατεβάζει ένα URL και το αποθηκεύει σε αρχείο
// // ==========================================================
...
// // ==========================================================
// // Helper: decompress .gz αρχείο σε memory buffer
// // ==========================================================
...
// // ==========================================================
// // Διαβάζει MNIST images από gzip αρχείο
// // ==========================================================
...
// // ==========================================================
// // Διαβάζει MNIST labels από gzip αρχείο
// // ==========================================================
...
//         throw std::runtime_error("Unexpected number of labels");

//     std::vector<unsigned char> labels(bytes.begin() + 8, bytes.begin() + 8 + num_samples);
//     return labels;
// }

// // ==========================================================
// // get_mnist() - κατεβάζει και επιστρέφει datasets
// // ==========================================================
// void get_mnist() {
...
//     auto train_images = load_images("train-images-idx3-ubyte.gz", 60000);
//     auto train_labels = load_labels("train-labels-idx1-ubyte.gz", 60000);

//     std::cout << "Reading test data...\n";
//     auto test_images = load_images("t10k-images-idx3-ubyte.gz", 10000);
//     auto test_labels = load_labels("t10k-labels-idx1-ubyte.gz", 10000);

//     std::cout << "\n>>> Done!\n";
//     std::cout << "Train set: " << train_images.size() << " images, "
//               << train_labels.size() << " labels\n";
//     std::cout << "Test set: " << test_images.size() << " images, "
//               << test_labels.size() << " labels\n";
// }
